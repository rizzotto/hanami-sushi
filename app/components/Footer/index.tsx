    ...
    <footer className="footer p-10 text-[--fg] mt-4 items-start flex flex-col md:flex-row md:justify-between md:items-center lg:items-start">
      ...
      <nav className="ml-2">
        ...
        <div className="grid grid-flow-col gap-4">
          <a
            href="https://twitter.com/search?q=sushi&src=typed_query"
            target="_blank"
            rel="noopener"
          >
            <svg
          ...
          <a
            href="https://www.instagram.com/sushitorestaurante/?hl=en"
            target="_blank"
            rel="noopener"
          >
            <svg
          ...
          <a
            href="https://www.facebook.com/sushitorestaurante/"
            target="_blank"
            rel="noopener"
          >
            <svg
